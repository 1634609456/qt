...
/// 系统定义
/// </summary>
typedef enum _YKE_SYSTEM_DEFINE
{
	/// <summary>
	/// 魔数
	/// </summary>
...
/// 系统错误类型
/// </summary>
typedef enum _YKE_SYSTEM_ERROR
{
	/// <summary>
	/// 无错误
	/// </summary>
...
/// 停止类型
/// </summary>
typedef enum _YKE_AXIS_STOP_TYPE
{
	/// <summary>
	/// 无
	/// </summary>
...
/// 轴等待信号类型
/// </summary>
typedef enum _YKE_AXIS_WAIT_TYPE
{
	/// <summary>
	/// 等待轴ACTIVE信号为OFF
	/// </summary>
...
/// 数字输入等待类型
/// </summary>
typedef enum _YKE_DIGITAL_INPUT_WAIT_TYPE
{
	/// <summary>
	/// 数字输入信号为OFF
	/// </summary>
...
/// 事件等待类型
/// </summary>
typedef enum _YKE_EVENT_WAIT_TYPE
{
	/// <summary>
	/// 等待事件完成
	/// </summary>
...
/// 过渡方式
/// </summary>
typedef enum _YKE_TRANSITION_MODE
{
	/// <summary>
	/// 无过渡
	/// </summary>
...
/// 圆弧辅助点模式
/// </summary>
typedef enum _YKE_CIRCULAR_AUX_MODE
{
	/// <summary>
	/// 指定圆弧上一点
	/// </summary>
...
/// 圆弧路径选择
/// </summary>
typedef enum _YKE_CIRCULAR_PATH_CHOICE
{
	/// <summary>
	/// 顺时针,圆心模式使用
	/// </summary>
...
/// 编码器模式
/// </summary>
typedef enum _YKE_ENCODER_MODE
{
	/// <summary>
	/// 脉冲+方向
	/// </summary>
...
/// 比较器模式
/// </summary>
typedef enum _YKE_COMPARE_MODE
{
	/// <summary>
	/// 固定位置
	/// </summary>
...
/// 示波器触发模式
/// </summary>
typedef enum _YKE_OSC_TRIG_TYPE
{
	/// <summary>
	/// 自由运行
	/// </summary>
...
/// 示波器监控对象类型
/// </summary>
typedef enum _YKE_OSC_ITEM_TYPE
{
	/// <summary>
	/// 轴数据
	/// </summary>
...
/// 轴信息采样数据类型
/// </summary>
typedef enum _YKE_AXIS_ITEM_TYPE
{
	/// <summary>
	/// 规划速度
	/// </summary>
...
/// 事件数据类型
/// </summary>
typedef enum _YKE_EVENT_ITEM_TYPE
{
	/// <summary>
	/// 启动命令
	/// </summary>
...
/// 多轴联动数据采集类型
/// </summary>
typedef enum _YKE_MULTI_AXIS_ITEM_TYPE
{
	/// <summary>
	/// active信号
	/// </summary>
...
/// 等待事件数据采集类型
/// </summary>
typedef enum _YKE_WAIT_ITEM_TYPE
{
	/// <summary>
	/// active信号
	/// </summary>
...
/// 轴跟随信息
/// </summary>
typedef enum _YKE_AXIS_FOLLOW_TYPE
{
	/// <summary>
	/// 规划位置
	/// </summary>
...
/// 轴位置比较模式
/// </summary>
typedef enum _YKE_AXIS_COMPARE_TYPE
{
	/// <summary>
	/// 规划位置
	/// </summary>
...
/// 坐标系跟随信息
/// </summary>
typedef enum _YKE_FOLLOW_GROUP_TYPE
{
	/// <summary>
	/// XY已移动距离
	/// </summary>
...
/// 系统信息采样数据类型
/// </summary>
typedef enum _YKE_SYSTEM_ITEM_TYPE
{
	/// <summary>
	/// 运动周期抖动ms
	/// </summary>
...
/// 跟随方式
/// </summary>
typedef enum _YKE_AXIS_FOLLOW_MODE
{
	/// <summary>
	/// 比例跟随
	/// </summary>
...
/// 传送带同步状态
/// </summary>
typedef enum _YKE_CONVEYOR_SYNC_STATUS
{
	/// <summary>
	/// 同步中
	/// </summary>
...
/// 捕获源
/// </summary>
typedef enum _YKE_CAPTURE_SOURCE
{
	/// <summary>
	/// 捕获编码器
	/// </summary>
...
/// 双轴混合模式
/// </summary>
typedef enum _YKE_COMBINE_MODE
{
	/// <summary>
	/// 加法
	/// </summary>
...
/// 同步运动模式
/// </summary>
typedef enum _YKE_SYNC_AXIS_MODE
{
	/// <summary>
	/// 按轴最大限制运行
	/// </summary>
...
/// 坐标系报警后输出状态
/// </summary>
typedef enum _YKE_GROUP_OUTPUT_IN_WARN
{
	/// <summary>
	/// 保持当前状态
	/// </summary>
...
/// 急停信号有效后给轴的控制命令
/// </summary>
typedef enum _YKE_EMG_AXIS_BEGAVIOR
{
	/// <summary>
	/// 保持
	/// </summary>
...
/// 坐标系采样数据类型
/// </summary>
typedef enum _YKE_GROUP_ITEM_TYPE
{
	/// <summary>
	/// 忙信号
	/// </summary>
...
/// 坐标系中位置比较模式
/// </summary>
typedef enum _YKE_GROUP_COMPARE_MODE
{
	/// <summary>
	/// 到达后立即输出
	/// </summary>
...
/// 坐标系中数字输出模式
/// </summary>
typedef enum _YKE_GROUP_DO_MODE
{
	/// <summary>
	/// 单次输出
	/// </summary>
...
/// 坐标系中PWM跟随模式
/// </summary>
typedef enum _YKE_GROUP_PWM_MODE
{
	/// <summary>
	/// 固定参数输出
	/// </summary>
...
/// 轴类型,coppylia仿真使用
/// </summary>
typedef enum _YKE_AXIS_SIM_TYPE
{
	/// <summary>
	/// 直线轴
	/// </summary>
...
/// 触发类型
/// </summary>
typedef enum _YKE_TRIGGER_TYPE
{
	/// <summary>
	/// 剩余时间(毫秒单位)
	/// </summary>
...
/// 信号源
/// </summary>
typedef enum _YKE_SIGNAL_SOURCE_TYPE
{
	/// <summary>
	/// 数字输入
	/// </summary>
...
/// 两个BIT位合成条件
/// </summary>
typedef enum _YKE_LOGIC_CONDITIONS
{
	/// <summary>
...
/// 事件状态
/// </summary>
typedef enum _YKE_EVENT_STATUS_TYTE
{
	/// <summary>
	/// 空闲
	/// </summary>
...
/// M/H辅助功能相对过渡段执行时间类型
/// </summary>
typedef enum _YKE_CNC_ACTION_TYPE
{
	/// <summary>
	/// 平滑轮廓中(default)
	/// </summary>
...
/// Akima样条过渡切向类型
/// </summary>
typedef enum _YKE_CNC_ASPLINE_TRANS_TYPE
{
	/// <summary>
	/// 算法自动计算(default)
	/// </summary>
...
/// </summary>
typedef enum _YKE_CNC_CHECK_JERK_TYPE
{
	/// <summary>
	/// 不监控(default)
	/// </summary>
...
/// HSC_Serface平滑圆弧优化类型
/// </summary>
typedef enum _YKE_HSC_CIR_MODE
{
	/// <summary>
	/// 圆弧轮廓平滑(default)
	/// </summary>
...
/// CNC指令模式
/// </summary>
typedef enum _YKE_CNC_INS_MODE
{
	/// <summary>
	/// API模式
	/// </summary>
...
/// 日志过滤选择
/// </summary>
typedef enum _YKE_LOGGER_FILTER_TYPE
{
	/// <summary>
	/// 采集所有指令
	/// </summary>
...
/// 授权状态
/// </summary>
typedef enum _YKE_LICENSE_STATUS
{
	/// <summary>
	/// 正常
	/// </summary>
...
/// 工程配置数据掩码,按位定义
/// </summary>
typedef enum _YKE_PROJECT_MASK
{
	/// <summary>
	/// 全局配置
	/// </summary>
...
/// PLC命令类型
/// </summary>
typedef enum _YKE_PLC_CMD_TYPE
{
	/// <summary>
	/// 无效
	/// </summary>
