...
namespace YKCat2
{
	...
	/// 输入信号配置
	/// </summary>
	public struct YKS_AxisSwitchConfig
	{
		/// <summary>
		/// 输入类型
		/// </summary>
	...
	public struct YKS_SysProfile
	{
		...
		public sbyte[] dog_serial_numberB;
	...
	/// 数字输入配置
	/// </summary>
	public struct YKS_DigitalInput
	{
		/// <summary>
		/// FALSE=不启用 TRUE=启用
		/// </summary>
	...
	/// 数字输出配置
	/// </summary>
	public struct YKS_DigitalOutput
	{
		/// <summary>
		/// FALSE=不启用 TRUE=启用
		/// </summary>
	...
	/// 同步数字输出配置
	/// </summary>
	public struct YKS_DigitalOutputCycle
	{
		/// <summary>
		/// 字节偏移[0,512)
		/// </summary>
	...
	/// windows蓝屏后的行为
	/// </summary>
	public struct YKS_BlueScreenConfig
	{
		/// <summary>
		/// FALSE=不启用 TRUE=启用
		/// </summary>
	...
	/// 硬件急停配置信息
	/// </summary>
	public struct YKS_HardEmgProfile
	{
		/// <summary>
		/// 急停输入
		/// </summary>
		[Description("急停输入")]
		[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
		public YKS_DigitalInput[] emg_stop_input;
		...
		[Description("急停输出")]
		[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
		public YKS_DigitalOutput[] emg_stop_output;
	...
	public struct YKS_EmgStatus
	{
		...
		[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
		public YKE_BOOL[] emg_stop_input;
	...
	/// 总线数据包的辅助信息
	/// </summary>
	public struct YKS_BusPacketHeader
	{
		/// <summary>
		/// 时间(毫秒单位)
		/// </summary>
	...
	/// 从站PDO配置
	/// </summary>
	public struct YKS_SlavePdoConfig
	{
		/// <summary>
		/// 主索引
		/// </summary>
	...
	/// 模轴参数
	/// </summary>
	public struct YKS_AxisProfileModulo
	{
		/// <summary>
	...
	/// 单轴运动曲线参数
	/// </summary>
	public struct YKS_AxisProfileMotion
	{
		/// <summary>
		/// 加速曲线选择
		/// </summary>
	...
	/// 单轴基本运动参数配置
	/// </summary>
	public struct YKS_AxisProfileBase
	{
		/// <summary>
	...
	/// 单轴基本运动参数,到位相关
	/// </summary>
	public struct YKS_AxisProfileInp
	{
		/// <summary>
	...
	/// 单轴基本运动参数, 跟随误差相关
	/// </summary>
	public struct YKS_AxisProfilePositionLag
	{
		/// <summary>
	...
	/// 清驱动器报警机制设置
	/// </summary>
	public struct YKS_AxisProfileClearDrv
	{
		/// <summary>
	...
	/// 轴使能机制设置
	/// </summary>
	public struct YKS_AxisProfilePowerOn
	{
		/// <summary>
		/// 等待使能完成时间[0,60000](ms)
		/// </summary>
	...
	/// 轴前馈配置
	/// </summary>
	public struct YKS_AxisProfileFeedforward
	{
		/// <summary>
	...
	/// 轴基本配置
	/// </summary>
	public struct YKS_AxisConfigBase
	{
		/// <summary>
		/// 主站
		/// </summary>
	...
	/// 规划信息
	/// </summary>
	public struct YKS_AxisStatusPlanner
	{
		/// <summary>
		/// 规划器标记,内部使用
		/// </summary>
	...
	/// 轴位置相关状态
	/// </summary>
	public struct YKS_AxisStatusPosition
	{
		/// <summary>
	...
	/// 轴补偿状态
	/// </summary>
	public struct YKS_AxisStatusCompensation
	{
		/// <summary>
	...
	/// 轴跟随状态
	/// </summary>
	public struct YKS_AxisStatusFollow
	{
		/// <summary>
	...
	/// 轴基本状态
	/// </summary>
	public struct YKS_AxisStatusBase
	{
		/// <summary>
		/// 运动类型
		/// </summary>
	...
	/// 多轴运动状态
	/// </summary>
	public struct YKS_MultiAxisStatus
	{
		/// <summary>
		/// TRUE=运行中 FLASE=空闲
		/// </summary>
	...
	/// 轴软件探针配置
	/// </summary>
	public struct YKS_AxisProbeConfigSoft
	{
		/// <summary>
		/// 触发输入
		/// </summary>
	...
	/// 软件探针状态
	/// </summary>
	public struct YKS_AxisProbeStatusSoft
	{
		/// <summary>
	...
	/// 回原点参数
	/// </summary>
	public struct YKS_AxisHomeConfig
	{
		/// <summary>
		/// 速度曲线
		/// </summary>
	...
	/// 运动仿真规划信息
	/// </summary>
	public struct YKS_MovePositionSimResult
	{
		/// <summary>
	...
	/// 绝对运动配置
	/// </summary>
	public struct YKS_MoveAbsoluteConfig
	{
		/// <summary>
	...
	/// 仿真运动变参数配置
	/// </summary>
	public struct YKS_MovePositionSimTrigger
	{
		/// <summary>
		/// 启用变参数
		/// </summary>
	...
	/// 仿真运动启动配置
	/// </summary>
	public struct YKS_MovePositionSimConfig
	{
		/// <summary>
		/// 运动参数
		/// </summary>
	...
	/// 传送带运动配置
	/// </summary>
	public struct YKS_MoveConveyorConfig
	{
		/// <summary>
		/// 传送带移动方向
		/// </summary>
	...
	/// 相对运动配置
	/// </summary>
	public struct YKS_MoveRelativeConfig
	{
		/// <summary>
	...
	/// 速度运动配置
	/// </summary>
	public struct YKS_MoveVelocityConfig
	{
		/// <summary>
		/// 运动方向
		/// </summary>
	...
	/// 转矩运动配置
	/// </summary>
	public struct YKS_MoveTorqueConfig
	{
		/// <summary>
	...
	/// 间隙补偿配置
	/// </summary>
	public struct YKS_BacklashConfig
	{
		/// <summary>
		/// 补偿方向
		/// </summary>
	...
	/// 一维螺距补偿配置
	/// </summary>
	public struct YKS_PitchError1DConfig
	{
		/// <summary>
	...
	/// 二维螺距补偿配置
	/// </summary>
	public struct YKS_PitchError2DConfig
	{
		/// <summary>
	...
	/// 单轴跟随配置
	/// </summary>
	public struct YKS_FollowAxis1Config
	{
		/// <summary>
		/// 跟随方式
		/// </summary>
	...
	/// 双轴跟随配置
	/// </summary>
	public struct YKS_FollowAxis2Config
	{
		/// <summary>
		/// 轴合成类型
		/// </summary>
	...
	/// UG跟随配置
	/// </summary>
	public struct YKS_FollowUgConfig
	{
		/// <summary>
		/// 跟随曲线类型
		/// </summary>
	...
	/// 坐标系跟随配置
	/// </summary>
	public struct YKS_FollowGroupConfig
	{
		/// <summary>
		/// 坐标系序号
		/// </summary>
	...
	/// 本地编码器跟随配置
	/// </summary>
	public struct YKS_FollowEncoderConfig
	{
		/// <summary>
		/// 跟随曲线类型
		/// </summary>
	...
	/// 坐标系配置
	/// </summary>
	public struct YKS_GroupProfile
	{
		/// <summary>
		/// 最高速度[0,DOUBLE_MAX](unit/s)
		/// </summary>
	...
	/// MARK坐标系转换
	/// </summary>
	public struct YKS_GroupTransMarkConfig
	{
		/// <summary>
		/// 旋转中心x(以图纸坐标为参考)
		/// </summary>
	...
	/// 坐标系附加的XY输出
	/// </summary>
	public struct YKS_GroupAddiXYConfig
	{
		/// <summary>
		/// X轴序号
		/// </summary>
	...
	/// 坐标系基本状态
	/// </summary>
	public struct YKS_GroupStatusBase
	{
		/// <summary>
		/// 运行主站
		/// </summary>
	...
	/// 坐标系CNC模块状态, 须开启CNC选项
	/// </summary>
	public struct YKS_GroupStatusCnc
	{
		/// <summary>
	...
	/// 坐标系直线插补,绝对模式
	/// </summary>
	public struct YKS_MoveLinearAbsoluteConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// 坐标系直线插补,相对模式
	/// </summary>
	public struct YKS_MoveLinearRelativeConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// 坐标系螺旋插补,相对模式
	/// </summary>
	public struct YKS_MoveHelixRelativeConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// 坐标系螺旋插补,绝对模式
	/// </summary>
	public struct YKS_MoveHelixAbsoluteConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// 坐标系圆弧插补,绝对模式
	/// </summary>
	public struct YKS_MoveCircularAbsoluteConfig
	{
		/// <summary>
		/// 识别码[0,UINT32_MAX]
		/// </summary>
	...
	/// 坐标系圆弧插补,相对模式
	/// </summary>
	public struct YKS_MoveCircularRelativeConfig
	{
		/// <summary>
		/// 识别码[0,UINT32_MAX]
		/// </summary>
	...
	/// </summary>
	public struct YKS_MoveCardinalRelativeConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// </summary>
	public struct YKS_MoveCardinalAbsoluteConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// 数字输入信号等待条件
	/// </summary>
	public struct YKS_WaitDigitalInput
	{
		/// <summary>
		/// 信号数量[1, 32]
		/// </summary>
	...
	/// 圆形区域保护配置
	/// </summary>
	public struct YKS_CircleZoneConfig
	{
		/// <summary>
		/// 轴数量,固定为2
		/// </summary>
	...
	/// 圆形区域保护状态
	/// </summary>
	public struct YKS_CircleZoneStatus
	{
		/// <summary>
		/// FALSE=禁用 TRUE=启用
		/// </summary>
	...
	/// 本地PCI卡配置信息
	/// </summary>
	public struct YKS_CardConfigPCI
	{
		/// <summary>
		/// 0:T serial
		/// </summary>
	...
	/// 本地PCI卡脉冲轴IO信息
	/// </summary>
	public struct YKS_AxisStausPCI
	{
		/// <summary>
		/// 脉冲口序号
		/// </summary>
	...
	/// 本地PCI高速卡编码器配置
	/// </summary>
	public struct YKS_EncoderConfig
	{
		/// <summary>
		/// 模式
		/// </summary>
	...
	/// 本地PCI高速卡位置比较器配置
	/// </summary>
	public struct YKS_CompareConfig
	{
		/// <summary>
		/// 比较模式
		/// </summary>
	...
	/// 监控对象：坐标系
	/// </summary>
	public struct YKS_OscItemGroup
	{
		/// <summary>
	...
	/// 监控对象：对象字典
	/// </summary>
	public struct YKS_OscItemSlaveObject
	{
		/// <summary>
		/// 主站选择
		/// </summary>
	...
	/// 监控对象：UG
	/// </summary>
	public struct YKS_OscItemSlaveUG
	{
		/// <summary>
		/// 主站选择
		/// </summary>
	...
	/// 监控对象：系统信息
	/// </summary>
	public struct YKS_OscItemSystem
	{
		/// <summary>
		/// 主站选择
		/// </summary>
	...
	/// 监控对象：编码器
	/// </summary>
	public struct YKS_OscItemEncoder
	{
		/// <summary>
		/// 卡选择,默认0
		/// </summary>
	...
	/// 监控对象：事件
	/// </summary>
	public struct YKS_OscItemEvent
	{
		/// <summary>
		/// 事件序号[0,YKE_EVENT_NUM)
		/// </summary>
	...
	/// 监控对象：多轴联动
	/// </summary>
	public struct YKS_OscItemMultiAxis
	{
		/// <summary>
	...
	/// 打印日志其他配置
	/// </summary>
	public struct YKS_LoggerItemConfig
	{
		/// <summary>
		/// 单轴 TRUE=启用 FALSE=禁用
		/// </summary>
	...
	/// 日志配置
	/// </summary>
	public struct YKS_LoggerConfig
	{
		/// <summary>
		/// 文件路径
		/// </summary>
		...
		[Description("采集配置")]
		[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
		public YKS_LoggerItemConfig[] item_config;
	}

	/// <summary>
	/// 保留
	/// </summary>
	public struct YKS_ExcTrackItem
	{
		/// <summary>
		/// 保留
		/// </summary>
	...
	/// 保留
	/// </summary>
	public struct YKS_ExcTrackConfig
	{
		/// <summary>
		/// 缓存数量
		/// </summary>
	...
	/// 软模式位置比较器配置
	/// </summary>
	public struct YKS_CompareConfigSoft
	{
		/// <summary>
		/// 比较模式
		/// </summary>
	...
	/// 本地PCI高速卡位置比较器比较数据
	/// </summary>
	public struct YKS_CompareItemData
	{
		/// <summary>
	...
	/// 软件模式位置比较器比较数据
	/// </summary>
	public struct YKS_CompareItemDataSoft
	{
		/// <summary>
	...
	/// 本地PCI高速卡位置比较器状态
	/// </summary>
	public struct YKS_CompareStatus
	{
		/// <summary>
		/// 数据队列头位置
		/// </summary>
	...
	/// 软件模式位置比较器状态
	/// </summary>
	public struct YKS_CompareStatusSoft
	{
		/// <summary>
		/// 数据队列头位置
		/// </summary>
	...
	/// 本地PCI高速卡位置锁存配置
	/// </summary>
	public struct YKS_CaptureConfig
	{
		/// <summary>
		/// 锁存源选择
		/// </summary>
	...
	/// 坐标系内数字输出配置
	/// </summary>
	public struct YKS_GroupDoConfig
	{
		/// <summary>
		/// 位置比较模式
		/// </summary>
	...
	/// 坐标系内PWM输出配置
	/// </summary>
	public struct YKS_GroupPwmConfig
	{
		/// <summary>
		/// 位置比较模式
		/// </summary>
	...
	/// 坐标系内PDO写入配置
	/// </summary>
	public struct YKS_GroupWritePdoConfig
	{
		/// <summary>
		/// 比较模式
		/// </summary>
	...
	/// 坐标系内寄存器写入配置
	/// </summary>
	public struct YKS_GroupWriteRegisterConfig
	{
		/// <summary>
		/// 比较模式
		/// </summary>
	...
	/// 坐标系内启动事件配置
	/// </summary>
	public struct YKS_GroupWriteEventConfig
	{
		/// <summary>
		/// 比较模式
		/// </summary>
	...
	/// 坐标系外轴绝对运动配置
	/// </summary>
	public struct YKS_GroupMoveAbsoluteConfig
	{
		/// <summary>
		/// 位置比较模式
		/// </summary>
	...
	/// 坐标系外轴相对运动配置
	/// </summary>
	public struct YKS_GroupMoveRelativeConfig
	{
		/// <summary>
		/// 位置比较模式
		/// </summary>
	...
	/// 坐标系内延时配置
	/// </summary>
	public struct YKS_GroupDelayConfig
	{
		/// <summary>
	...
	/// 坐标系内等待数字输入配置
	/// </summary>
	public struct YKS_GroupDigitalInputConfig
	{
		/// <summary>
		/// 数字输入字节序号[0,512)
		/// </summary>
	...
	/// 坐标系内等待外轴运动完成
	/// </summary>
	public struct YKS_GroupWaitAxisConfig
	{
		/// <summary>
		/// 轴序号[0,YKE_AXIS_NUM)
		/// </summary>
	...
	/// 坐标系内等待PDO值
	/// </summary>
	public struct YKS_GroupWaitPdoConfig
	{
		/// <summary>
		/// 主站选择
		/// </summary>
	...
	/// 坐标系内等待寄存器值
	/// </summary>
	public struct YKS_GroupWaitRegisterConfig
	{
		/// <summary>
		/// 寄存器序号[0,YKE_GENDATA_SIZE)
		/// </summary>
	...
	/// 坐标系内等待事件
	/// </summary>
	public struct YKS_GroupWaitEventConfig
	{
		/// <summary>
	...
	/// Cardinal样条配置
	/// </summary>
	public struct YKS_GroupCardinalConfig
	{
		/// <summary>
		/// 张力系数(0,1)
		/// </summary>
	...
	/// 数字IO关联的硬件信息
	/// </summary>
	public struct YKS_DigitalIOHardInfo
	{
		/// <summary>
	...
	/// 软限位设置
	/// </summary>
	public struct YKS_AxisSoftLimitConfig
	{
		/// <summary>
	...
	/// 硬限位启用
	/// </summary>
	public struct YKS_AxisHardLimitConfig
	{
		/// <summary>
		/// 正向硬限位
		/// FALSE=禁用 TRUE=启用
	...
	/// 多轴直线插补运动,相对模式
	/// </summary>
	public struct YKS_LinearInterpolationRelativeConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// 多轴直线插补运动,绝对模式
	/// </summary>
	public struct YKS_LinearInterpolationAbsoluteConfig
	{
		/// <summary>
		/// 轴数量[2,YKE_MULTI_AXIS_NUM]
		/// </summary>
	...
	/// 多轴直线同步运动,相对模式
	/// </summary>
	public struct YKS_LinearSyncRelativeConfig
	{
		/// <summary>
		/// 同步模式
		/// </summary>
	...
	/// 多轴直线同步运动,绝对模式
	/// </summary>
	public struct YKS_LinearSyncAbsoluteConfig
	{
		/// <summary>
		/// 同步模式
		/// </summary>
	...
	/// 多轴同时启动
	/// </summary>
	public struct YKS_SyncStartConfig
	{
		/// <summary>
		/// 同步模式
		/// </summary>
	...
	/// 圆弧插补,相对模式
	/// </summary>
	public struct YKS_CircularInterpolationRelativeConfig
	{
		/// <summary>
		/// 轴数量[2,3]
		/// </summary>
	...
	/// 圆弧插补,绝对模式
	/// </summary>
	public struct YKS_CircularInterpolationAbsoluteConfig
	{
		/// <summary>
		/// 轴数量[2,3]
		/// </summary>
	...
	/// 探针配置
	/// </summary>
	public struct YKS_ProbeConfigSoft
	{
		/// <summary>
		/// 数字输入
		/// </summary>
	...
	/// 探针状态
	/// </summary>
	public struct YKS_ProbeStatusSoft
	{
		/// <summary>
		/// 激活状态 FALSE=未激活  TRUE=已激活
		/// </summary>
	...
	/// 轴触发状态
	/// </summary>
	public struct YKS_AxisTriggerStatus
	{
		/// <summary>
		/// FALSE=空闲 TRUE=等待触发
		/// </summary>
	...
	/// 单信号触发参数
	/// </summary>
	public struct YKS_TriggerArgOneSignal
	{
		/// <summary>
		/// 信号源选择
		/// </summary>
	...
	/// 双信号触发参数
	/// </summary>
	public struct YKS_TriggerArgTwoSignal
	{
		/// <summary>
		/// 号源1
		/// </summary>
	...
	/// 轴位置条件触发
	/// </summary>
	public struct YKS_TriggerArgAxisPosition
	{
		/// <summary>
		/// 轴序号[0,YKE_AXIS_NUM)
		/// </summary>
	...
	/// 轴时间条件触发
	/// </summary>
	public struct YKS_TriggerArgAxisTime
	{
		/// <summary>
		/// 轴序号[0,YKE_AXIS_NUM)
		/// </summary>
	...
	/// 轴速度条件触发
	/// </summary>
	public struct YKS_TriggerArgAxisVelocity
	{
		/// <summary>
		/// 轴序号[0,YKE_AXIS_NUM)
		/// </summary>
	...
	/// 轴转矩条件触发
	/// </summary>
	public struct YKS_TriggerArgAxisTorque
	{
		/// <summary>
		/// 轴序号
		/// </summary>
	...
	/// 从站PDO触发条件
	/// </summary>
	public struct YKS_TriggerArgSlavePDO
	{
		/// <summary>
		/// 主站
		/// </summary>
	...
	/// 编码器触发条件
	/// </summary>
	public struct YKS_TriggerArgEncoder
	{
		/// <summary>
		/// 通道号
		/// </summary>
	...
	/// 触发输出:位参数写入
	/// </summary>
	public struct YKS_TriggerOutputOneBit
	{
		/// <summary>
		/// 信号源
		/// </summary>
	...
	/// 触发输出:轴停止
	/// </summary>
	public struct YKS_TriggerOutputStopAxis
	{
		/// <summary>
		/// 轴序号[0,YKE_AXIS_NUM)
		/// </summary>
	...
	/// 触发输出:启动坐标系
	/// </summary>
	public struct YKS_TriggerOutputStartGroup
	{
		/// <summary>
		/// 坐标系序号[0,YKE_GROUP_NUM)
		/// </summary>
	...
	/// 触发输出:启动多轴联动
	/// </summary>
	public struct YKS_TriggerOutputStartMultiAxis
	{
		/// <summary>
	...
	/// 触发输出:启动轴
	/// </summary>
	public struct YKS_TriggerOutputStartAxis
	{
		/// <summary>
		/// 轴序号[0,YKE_AXIS_NUM)
		/// </summary>
	...
	/// 触发输出:触发软急停信号
	/// </summary>
	public struct YKS_TriggerOutputSoftEmgStop
	{
		/// <summary>
		/// 急停通道序号
		/// </summary>
	...
	/// 触发输出:从站PDO写入
	/// </summary>
	public struct YKS_TriggerOutputSlavePDO
	{
		/// <summary>
		/// 主站
		/// </summary>
	...
	/// 触发输出:写入轴目标转矩
	/// </summary>
	public struct YKS_TriggerOutputTargetTorque
	{
		/// <summary>
		/// 轴序号
		/// </summary>
	...
	/// 触发输出:延时
	/// </summary>
	public struct YKS_TriggerOutputDelayMs
	{
		/// <summary>
		/// 主站
		/// </summary>
	...
	/// 触发输出:写数据寄存器
	/// </summary>
	public struct YKS_TriggerOutputDataReg
	{
		/// <summary>
		/// 主站
		/// </summary>
	...
	/// 基于控制点的AKIMA样条配置
	/// </summary>
	public struct YKS_CncASplineConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// CNC轮廓角偏差平滑配置
	/// </summary>
	public struct YKS_CncContourDevConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// CNC轮廓角距离平滑配置
	/// </summary>
	public struct YKS_CncContourDistConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// CNC动态轮廓优化平滑配置
	/// </summary>
	public struct YKS_CncContourDistSoftConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// CNC进给主轴动态轮廓优化平滑配置
	/// </summary>
	public struct YKS_CncContourDistMasterConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// CNC插入点平滑配置
	/// </summary>
	public struct YKS_CncContourPosConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
		...
		[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
		public double[] pos_position;
	}

	/// <summary>
	/// CNC完整轮廓动态优化平滑配置
	/// </summary>
	public struct YKS_CncContourPtpConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// HSC_B样条平滑配置
	/// </summary>
	public struct YKS_CncHscBConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// HSC_Surface平滑配置
	/// </summary>
	public struct YKS_CncHscSConfig
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// HSC_PCS1平滑参数
	/// </summary>
	public struct YKS_CncHscPcs1Config
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// HSC_PCS2平滑参数
	/// </summary>
	public struct YKS_CncHscPcs2Config
	{
		/// <summary>
		/// 用户标记
		/// </summary>
	...
	/// 写CNC参数状态
	/// </summary>
	public struct YKS_CncParaStatus
	{
		/// <summary>
		/// 命令状态 0:未完成 1:已完成
		/// </summary>
